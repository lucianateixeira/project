...
router.get('/get/html', function(req, res) {
    ...
    var xml = fs.readFileSync('ListofBook.xml', 'utf8'); //We are reading in the XML file
...
router.post('/post/json', function(req, res) {
  ...
  function appendJSON(obj) {
    ...
    xmlFileToJs('ListofBook.xml', function(err, result) {
      if (err) throw (err);
      ...
      jsToXmlFile('ListofBook.xml', result, function(err) {
