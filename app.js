...
router.get('/get/html', function(req, res) {
    ...
    var xml = fs.readFileSync('ListofBooks.xml', 'utf8'); //We are reading in the XML file
    var xsl = fs.readFileSync('BookTable.xsl', 'utf8'); //We are reading in the XSL file
...
router.post('/post/json', function(req, res) {
  ...
  function appendJSON(obj) {
    ...
    xmlFileToJs('ListofBooks.xml', function(err, result) {
      if (err) throw (err);
      ...
      jsToXmlFile('ListofBooks.xml', result, function(err) {
